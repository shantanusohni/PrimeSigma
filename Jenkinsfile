    ...
    stages {
        ...
        stage('Deploy to GKE Cluster') {
            steps{
                ...
                step([$class: 'KubernetesEngineBuilder', projectId: env.PROJECT_ID, clusterName: env.CLUSTER_NAME, location: env.LOCATION, manifestPattern: 'json-server-deployment.yml', credentialsId: env.CREDENTIALS_ID, verifyDeployments: true])
